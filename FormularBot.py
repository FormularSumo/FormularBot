...
class FormularBot(GoslingAgent):
    ...
    def run(agent):
        ...
        if agent.kickoff_flag and (closest_to_ball or (joint_closest_to_ball and not(ally_taking_kickoff == True) and (kickoff_position == 'diagonal_left' or kickoff_position == 'back_left'))):
            go_for_kickoff = True
        else:
